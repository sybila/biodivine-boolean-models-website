    ...
    return (
        <>
            <div className="header">
                ...
                <Link to="/models"><button>Model Repository</button></Link>
            </div>
            <div className="content">
                <h2>Biodivine Boolean Models (BBM) Benchmark Dataset</h2>
                ...
                <p>If you want to learn more, you can read our&nbsp;
                    <a href="https://github.com/sybila/biodivine-boolean-models/blob/main/report/report.pdf">
                         technical report</a>.
                </p>
                <p><b>Where are the models?</b> If you just need individual models, you can head to the <span className="code">./models</span>
                    &nbsp;directory where each model has a subdirectory containing <span className="code">bnet</span> / <span className="code">aeon</span> /&nbsp;
                    <span className="code">sbml</span> source files as well as JSON metadata file and a human-friendly readme.
                    There is also a <span className="code">models/summary.csv</span> file with the full list of models. Alternatively,
                    you can download one of the "edition archives" in the <a
                        href="https://github.com/sybila/biodivine-boolean-models/releases">repository releases</a>.
                    These contain the same model files as the <span className="code">./models</span> directory,
                    but are grouped by model format and exported as a single directory, so they are easier to
                    digest by scripts or programs.
                </p>
                <div className="note">
                    <p className="note_text">Note on model inputs (source nodes): By default, all inputs
                ...
                <div className="note">
                    <p className="note_text">Note on multivalued models: The dataset also includes
                        Booleanized versions of multi-valued models. If you wish to exclude these,
                        they can be identified using the keyword <span className="code">multi-valued</span>.
                    </p>
                </div>
                <h3>Citation</h3>
                <p>If you found this dataset useful in your academic work, you can cite the&nbsp;
                    <a href="https://www.biorxiv.org/content/10.1101/2023.06.12.544361v1">technical report</a>:
                </p>
                <div className="code_block">
                    <p className="code_block_text">
                ...
                <h3>Custom Model Editions</h3>
                <p>
                    If you need to generate models with specific properties (or formats), you can use
                    <span className="code">bundle.py</span> to generate custom model editions. In particular,
                    for each edition you can pick the desired format
                    (<span className="code">bnet</span>/<span className="code">aeon</span>/<span className="code">sbml</span>),
                    desired input representation (<span className="code">free</span>, constant <span className="code">true</span>
                    or <span className="code">false</span> , random, or the <span className="code">identity</span> function),
                ...
                <div className="note">
                    <p className="note_text">
                        Random input valuations: If you select <span className="code">random</span> input values,
                ...
                <p>
                    Once you have <a href="https://github.com/sybila/biodivine-aeon-py">AEON.py</a> installed
                    (<span className="code">pip install -r requirements.txt</span>), you can simply run
                    <span className="code">python3 bundle.py</span> and answer the script prompts with your
                ...
                <p>
                    ...
                    <a href="https://github.com/sybila/biodivine-boolean-models/blob/main/CONTRIBUTING.md">CONTRIBUTING.md</a>,
                    you can find how to let us know about a new model through an issue or a pull request.
                </p>
                <h3>Random Networks</h3>
                <p>
                    ...
                    <a href="https://zenodo.org/record/3714876#.YxXVYi8Rr0o">this</a> or&nbsp;
                    <a href="https://github.com/daemontus/artifact_cav2021/tree/master/benchmarks_random">this&nbsp;</a>
                ...
                <div>
                    <ul>
                        <li>GINsim model export automatically "hides" some logical errors in models
                            (<a href="(https://github.com/sybila/biodivine-boolean-models/issues/57)">Issue 57</a>).</li>
                        <li>Regulatory network data is unavailable for <span className="code">.bnet</span> models
                            (<a href="https://github.com/sybila/biodivine-boolean-models/issues/61">Issue 61</a>).</li>
                        <li>Extra metadata available in <span className="code">.sbml</span> models is erased by the static analysis workflow
                            (<a href="https://github.com/sybila/biodivine-boolean-models/issues/60">Issue 60</a>).</li>
                        <li>In the future, we may incorporate more structural metadata; SCCs of the regulatory graph,
                            ...
                            (<a href="https://github.com/sybila/biodivine-boolean-models/issues/59">Issue 59</a>).</li>
                    </ul>
                </div>
                <div className="note">
                    <p className="note_text">
                ...
                <Link to="/models"><button>Learn More</button></Link>
            </div>
        </>
    )
};
