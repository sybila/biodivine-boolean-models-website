    ...
    return (
        <>
            <div className="page__header">
                ...
                <Link to="/models">
                    <button className="page__button">Model Repository</button>
                </Link>
            </div>
            <div className="page__content">
                ...
                <p>
                    ...
                    and methods. At the moment, there are 230+ models from major model repositories (GINsim,
                ...
                <p>
                    <b>Where are the models?</b> If you just need individual models, you can head to the{' '}
                    <span className="code">./models</span>
                    &nbsp;directory where each model has a subdirectory containing{' '}
                    ...
                    but are grouped by model format and exported as a single directory, so they are easier to digest by
                    scripts or programs.
                </p>
                ...
                <div className="main-page__note">
                    <p className="main-page__note-text">
                        ...
                        <span className="page__code">multi-valued</span>.
                    </p>
                </div>
                ...
                <p>
                    ...
                    <span className="page__code">bundle.py</span> to generate custom model editions. In particular, for
                    each edition you can pick the desired format (<span className="page__code">bnet</span>/
                    <span className="page__code">aeon</span>/<span className="page__code">sbml</span>), desired input
                    representation (<span className="page__code">free</span>, constant{' '}
                    <span className="page__code">true</span>
                    or <span className="page__code">false</span> , random, or the{' '}
                    <span className="page__code">identity</span> function), and you can filter the models using a Python
                    expression (e.g. you want to only include models with specific keywords or size).
                </p>
                <div className="main-page__note">
                    <p className="main-page__note-text">
                ...
                <p>
                    Once you have{' '}
                    <a className="page__link" href="https://github.com/sybila/biodivine-aeon-py">
                        AEON.py
                    </a>{' '}
                    installed (<span className="page__code">pip install -r requirements.txt</span>), you can simply run
                ...
                <p>
                    ...
                    <a className="page__link" href="https://zenodo.org/record/3714876#.YxXVYi8Rr0o">
                        this
                    </a>{' '}
                    or&nbsp;
                    <a
                ...
                <p>When working with the dataset, you may want to consider the following limitations:</p>
                <div>
                    <ul>
                        <li>
                        ...
                        <li>
                            Regulatory network data is unavailable for <span className="page__code">.bnet</span> models
                            (
                            <a
                                className="page__link"
                                href="https://github.com/sybila/biodivine-boolean-models/issues/61"
                            >
                                Issue 61
                            </a>
                            ).
                        ...
                        <li>
                            Extra metadata available in <span className="page__code">.sbml</span> models is erased by
                            the static analysis workflow (
                            <a
                                className="page__link"
                                href="https://github.com/sybila/biodivine-boolean-models/issues/60"
                            >
                                Issue 60
                            </a>
                            ).
                        ...
                        <li>
                            In the future, we may incorporate more structural metadata; SCCs of the regulatory graph,
                            feedback vertex set, positive/negative edges, etc. (
                            <a
                                className="page__link"
                                href="https://github.com/sybila/biodivine-boolean-models/issues/59"
                            >
                                Issue 59
                            </a>
                            ).
                ...
                <Link to="/models">
                    <button className="page__button">Learn More</button>
                </Link>
            </div>
        </>
    );
